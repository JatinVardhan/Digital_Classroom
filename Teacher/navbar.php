  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div>
        ...
        <div class="nav_list">
          <a href="ADashboard.php" class="nav_link ">
            <i class="bx bx-grid-alt nav_icon"></i>
            <span class="nav_name">Classes</span>
          </a>
          <a href="CreateClass.php" class="nav_link">
          <i class='bx bx-add-to-queue nav_icon' ></i>
            <span class="nav_name">Create Class </i></span>
          </a>
          ...
          <a href="Archive.php" class="nav_link">
          <i class='bx bx-archive-in nav_icon'></i>
            <span class="nav_name">Archive Classes</span>
          </a>
