  ...
  <div class="l-navbar" id="nav-bar">
    <nav class="nav">
      <div>
        ...
        <div class="nav_list">
          <a href="SDashboard.php" class="nav_link ">
          <i class='bx bxs-graduation nav_icon'></i>
            <span class="nav_name">Enrolled Classes</span>
          </a>
          <a href="JoinClass.php" class="nav_link">
          <i class='bx bx-message-square-add nav_icon'></i>
            <span class="nav_name">Join Class </i></span>
          </a>
          <a href="manageAttendance.php" class="nav_link">
          <i class='bx bx-calendar-check nav_icon'></i>
            <span class="nav_name">Check Attendance</span>
          </a>
