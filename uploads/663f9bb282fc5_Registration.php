...
$mail->SMTPAuth = true;
$mail->Username = 'jatin071103@gmail.com'; // Update with your SMTP username
$mail->Password = 'mbrc deso itrf zjet'; // Update with your SMTP password
$mail->SMTPSecure = 'tls'; // 'tls' or 'ssl'
$mail->Port = 587; // Change to the appropriate port for your SMTP server

// Set email details
$mail->setFrom('jatin071103@gmail.com', 'Jatin'); // Update with sender's email and name
$mail->addAddress($email); // Add recipient's email
$mail->Subject = 'Email Verification';
$mail->Body = 'Your verification code is: ' . $verificationCode; // Include the verification code dynamically
...
<body>
  ...
  <div class="container1 text-center px-5 py-4 <?php echo $_SESSION['email1'] ? 'visible' : 'hidden'; ?>">
    ...
    <div class="bottom mx-auto mt-4">
        <p onclick="changeEmail()">Change email</p> <!-- Add onclick event to trigger changeEmail function -->
...
<?php if ($_SESSION['email']) : ?>
  <script>
    ...
    function updateRemainingTime() {
        ...
        // Update the remaining time in the dataset attribute
  ...
  document.querySelectorAll('.otp-input input').forEach(input => {
    input.addEventListener('keydown', function(event) {
      ...
      if (event.key === 'Backspace' && this.value === '') {
        ...
        // Get the ID of the previous input field
